...
params <- list(
  booster = "gbtree",
  eta = 0.02,              # velocidad de aprendizaje
  max_depth = 4,           # más bajo para reducir overfitting
  min_child_weight = 10,   # más alto para requerir mínimo de datos en hijos
  gamma = 0.3,             # penaliza splits con ganancia pequeña
  subsample = 0.85,
  colsample_bytree = 0.8,
  lambda = 2.0,            # regularización L2 (Ridge)
  alpha = 1.0,             # regularización L1 (Lasso)
...
write_csv(submission, "submission_final_mae_optimized_v2.csv")
```
